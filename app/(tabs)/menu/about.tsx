      ...
      >
        ...
        >
          <View style={styles.logo_section}>
            ...
            />
            {/* reuses sectionHeader — same blue brand color */}
            <Text style={[styles.app_name, { color: theme.sectionHeader }]}>
              DawaMZ
            </Text>
            {/* reuses itemDescription — same muted secondary color */}
            <Text style={[styles.version, { color: theme.itemDescription }]}>
              {text.version}
            </Text>
          </View>
          ...
          {/* reuses sectionCard for bg, subtext for text */}
          <Text
            style={[
              styles.section_content,
              { backgroundColor: theme.sectionCard, color: theme.subtext },
              rtlStyle,
            ]}
          >
            {text.aboutContent}
          ...
          >
            {features.map((feature, index) => (
              <Text
                key={index}
                style={[styles.feature, { color: theme.subtext }, rtlStyle]}
              >
                • {feature}
              </Text>
            ))}
          ...
          {/* reuses itemDescription — same muted secondary color */}
          <Text style={[styles.copyright, { color: theme.itemDescription }]}>
            {text.copyright}
          </Text>
